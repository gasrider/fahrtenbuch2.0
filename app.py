...
def create_jahres_pdf(generated_data, jahr, user_info, fahrzeuge_df):
    ...
    story.append(Paragraph(f"Fahrzeug(e): {', '.join(fzg_list)}", styles['Normal'])); story.append(Spacer(1, 10*mm))
